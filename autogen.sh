...
./configure --without-scheme --enable-maintainer-mode --with-libctl=/home/zhy/local/libctl/ --prefix=/home/zhy/Documents/polariton/meep_install CPPFLAGS="-I$HOME/local/libctl/include/"  "$@"
